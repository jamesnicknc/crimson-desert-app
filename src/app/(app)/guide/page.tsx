...
const CHAPTERS: ChapterInfo[] = [
  ...
  {
    number: 9,
    title: 'The Sage of the Desert',
    subtitle: 'Chapter 9',
    summary: 'Journey into the Crimson Desert for the first time. Seek enlightenment from a desert hermit and face spiritual trials in the lawless wastes. Discover Fated Shadow, the highest ATK starting sword, in a dead-end room adjacent to the boss arena.',
    bosses: ['Desert Boss (TBD)'],
    rewards: ['Fated Shadow (sword)', 'Greysoul Howling Abyss Core'],
    tips: [
      'The Crimson Desert is completely lawless with powerful enemies',
      'Check dead-end rooms near boss arenas for the Fated Shadow sword',
      'Stock up on healing items before venturing into the desert',
      'Heat resistance gear helps significantly here',
    ],
  },
  {
    number: 10,
    title: 'Counterattack',
    subtitle: 'Chapter 10',
    summary: 'Unite all allied factions for a massive counterattack against the Black Bear forces. Rally the banners, hold war councils, and lead a siege against the Black Fortress. The All-Terrain Armored Gear (ATAG) vehicle is unlocked in this chapter.',
    bosses: ['Black Bear Commanders'],
    rewards: ['ATAG Vehicle Unlock', 'War Hero Equipment'],
    tips: [
      'This is the largest-scale battle in the game',
      'Coordinate with allied faction NPCs for bonus support',
      'The ATAG vehicle is extremely powerful in siege scenarios',
      'Ensure all side quests are done before this point',
    ],
  },
  {
    number: 11,
    ...
    subtitle: 'Chapter 11',
    summary: 'Revelations about the true nature of the Abyss and Pywel reshape everything you thought you knew. Confront hidden forces and unlock the Blackstar Dragon flying mount to take to the skies.',
    bosses: ['Hidden Forces (TBD)'],
    rewards: ['Blackstar Dragon (flying mount)'],
    tips: [
      'Major story reveals happen here that recontextualize earlier events',
      'The Blackstar Dragon unlocks full aerial exploration',
      'After unlocking flight, revisit earlier areas for hidden locations',
      'Prepare with the best gear available for challenging encounters',
    ],
  },
  {
    number: 12,
    title: 'The Abyss',
    subtitle: 'Chapter 12',
    summary: "Enter the final Abyss dimension to fulfill Gian's last wish by sealing the Rifts that threaten Providence. Face the ultimate battle against Hexe Marie, the grief-stricken dark sorcerer who stands as the game's final boss.",
    bosses: ['Hexe Marie'],
    rewards: ['Deep Abyss Core'],
    tips: [
      'Hexe Marie summons monsters and uses Abyss magic throughout the fight',
      'She is fully voice-acted with a tragic backstory about her slain child',
      'Use every skill and ability across all three characters',
      'Prepare Palmer Pills and maximum healing supplies',
    ],
  },
  {
    number: 13,
    title: "Journey's End",
    subtitle: 'Epilogue',
    summary: 'In the aftermath of the final battle, witness the resolution of the Greymanes\' story and the fate of Pywel. Post-game content unlocks including New Game+ and continued exploration.',
    bosses: [],
    rewards: ['Epilogue Completion Bonus', 'New Game+ Unlock'],
    tips: [
      'Post-game opens all remaining side content',
      'Faction quests and bounties can still be completed',
      'Explore with the Blackstar Dragon for previously inaccessible areas',
      'Unlocks New Game+ with carryover rewards and increased difficulty',
    ],
  },
];
...
const COMBAT_ELEMENTS = [
  {
    name: 'Physical',
    color: 'text-gray-300',
    description: 'Traditional blade and blunt force damage. The baseline element with no special effects but universal effectiveness.',
    advantages: ['Universally reliable', 'No setup required', 'Works against all enemy types'],
    weakness: 'None; all enemies take Physical damage. No bonus effects',
  },
  {
    name: 'Fire',
    color: 'text-orange-400',
    description: 'Causes attacks to incinerate and explode. Spreads across multiple targets when grouped. Requires multiple rapid hits to trigger the stun/burn effect.',
    advantages: ['Area damage spreads to grouped enemies', 'High damage against frost enemies', 'Pairs well with wide-arc weapons (greatswords, axes)'],
    weakness: 'Fire enemies resist or heal from fire attacks',
  },
  {
    name: 'Frost',
    color: 'text-sky-400',
    description: 'Freezes enemies solid, halting all movement and interrupting attacks. The most reliable crowd control element. Creates vulnerability windows for follow-up attacks.',
    advantages: ['Best crowd control in the game', 'Interrupts incoming attacks', 'Ice darts shot into water create floating ice platforms'],
    weakness: 'Frost enemies are immune; shorter effective range than Fire',
  },
  {
    name: 'Shock',
    color: 'text-yellow-300',
    description: 'Paralyzes enemies and disrupts shielded foes. Stun/paralysis effect activates faster than Ice but has shorter duration. Better for interrupting specific enemy attacks.',
    advantages: ['Fastest stun activation', 'Disrupts shields and guard', 'Chain-lightning potential against groups'],
    weakness: 'Shock enemies are resistant; shorter stun than Frost',
  },
  {
    name: 'Abyss',
    color: 'text-purple-400',
    description: 'Corrupted dimensional energy from The Abyss. Rare and powerful, tied to the Abyss Core and artifact system. Unlocked through story progression.',
    advantages: ['Bypasses some resistances', 'Unique mechanics', 'Essential for late-game content'],
    weakness: 'Abyss enemies reflect it; limited availability until mid-game',
  },
];
