...
export const metadata: Metadata = {
  title: 'Character Profiles - Kliff, Damiane & Oongka',
  description: 'Meet the three playable characters of Crimson Desert. Learn about Kliff the versatile mercenary, Damiane the swift duelist, and Oongka the mighty tank with their unique weapons and abilities.',
};
