...
export const TROPHIES: Trophy[] = [
  ...
  // Gold (4)
  { id: 'troph-g01', name: 'Conqueror of the Abysses', rarity: 'gold', description: 'Explore and master the multiple Abyss areas that threaten the world of Pywel.', category: 'Exploration' },
  { id: 'troph-g02', name: 'Expert Storyteller', rarity: 'gold', description: 'Complete the entire main story including all boss fights across Pywel.', category: 'Story' },
  { id: 'troph-g03', name: 'Expert Explorer', rarity: 'gold', description: 'Solve every exploration puzzle and fulfill all exploration challenges in Pywel.', category: 'Exploration' },
  { id: 'troph-g04', name: 'Unvanquished Strategist', rarity: 'gold', description: 'Use cunning strategy and tactics to overcome challenging encounters.', category: 'Combat' },
  // Silver (10)
  { id: 'troph-s01', name: 'Grand Collector of Arms', rarity: 'silver', description: 'Collect an impressive arsenal of special weapons from across the world of Pywel.', category: 'Collection' },
  { id: 'troph-s02', name: 'Tamer of Legends', rarity: 'silver', description: 'Tame legendary mounts and build an extraordinary stable of companions.', category: 'Mounts' },
  { id: 'troph-s03', name: 'Natural Collector', rarity: 'silver', description: 'Discover and catalog the natural wonders and creatures found throughout Pywel.', category: 'Collection' },
  { id: 'troph-s04', name: 'Proud Returnee', rarity: 'silver', description: 'Relocate the Greymane Camp from Howling Hill to Pailune.', category: 'Story' },
  { id: 'troph-s05', name: 'Pilgrim of Wonders', rarity: 'silver', description: 'Visit all the remarkable secret wonders and landmarks scattered across Pywel.', category: 'Exploration' },
  { id: 'troph-s06', name: 'Puzzle Solver', rarity: 'silver', description: 'Unravel all mysteries and solve every puzzle hidden throughout the world.', category: 'Exploration' },
  { id: 'troph-s07', name: 'Lightbringer', rarity: 'silver', description: 'Cleanse all Sanctums and bring light to the dark places of Pywel.', category: 'Exploration' },
  { id: 'troph-s08', name: 'True Gamer', rarity: 'silver', description: 'Master all minigames and side activities of Pywel.', category: 'Minigames' },
  { id: 'troph-s09', name: 'Protector of Pailune', rarity: 'silver', description: 'Finish Chapter 7 and defend the frozen lands of Pailune.', category: 'Story' },
  { id: 'troph-s10', name: 'Ultimate Hunter', rarity: 'silver', description: 'Hunt and defeat legendary beasts across every region of Pywel.', category: 'Combat' },
  // Bronze (20)
  ...
  { id: 'troph-b03', name: 'Conqueror of Spires', rarity: 'bronze', description: 'Conquer all the towering spires that pierce the sky across the lands of Pywel.', category: 'Exploration' },
  { id: 'troph-b04', name: 'Navigator of the Stars', rarity: 'bronze', description: 'Use the stars and celestial markers to navigate and explore Pywel.', category: 'Exploration' },
  { id: 'troph-b05', name: 'Master Camper', rarity: 'bronze', description: 'Activate the Greymane Camp at Howling Hill.', category: 'Camp' },
  { id: 'troph-b06', name: 'Master of Swords', rarity: 'bronze', description: 'Demonstrate mastery over the sword through skill and countless victories.', category: 'Combat' },
  { id: 'troph-b07', name: 'Master of Shields', rarity: 'bronze', description: 'Master the art of defense and shield combat.', category: 'Combat' },
  { id: 'troph-b08', name: 'Master of Bows', rarity: 'bronze', description: 'Prove your expertise with the bow through ranged combat mastery.', category: 'Combat' },
  { id: 'troph-b09', name: 'Master of Spears', rarity: 'bronze', description: 'Achieve mastery over the spear and polearm weapons.', category: 'Combat' },
  { id: 'troph-b10', name: 'Master of Two-Handed Weapons', rarity: 'bronze', description: 'Wield massive two-handed weapons with devastating expertise.', category: 'Combat' },
  { id: 'troph-b11', name: 'Master of Artillery', rarity: 'bronze', description: 'Unleash the full power of artillery weapons on the enemies of Pywel.', category: 'Combat' },
  { id: 'troph-b12', name: 'Master of Rapiers', rarity: 'bronze', description: 'Demonstrate supreme finesse and precision with the rapier.', category: 'Combat' },
  { id: 'troph-b13', name: 'Master of Firearms', rarity: 'bronze', description: 'Master the modern firearms of Pywel with deadly accuracy.', category: 'Combat' },
